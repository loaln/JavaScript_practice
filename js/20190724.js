...
function hightlightPage() {
	...
	for(var i = 0; i < links.length; i++) {
		...
		if(window.location.href.indexOf(linkurl) != -1) {
			...
			var linktext = links[i].lastChild.nodeValue.toLowerCase(); //将文本转换为小写
...
function prepareSlideshow() {
	...
	frame.setAttribute("src", "../../image/20190724/frame.png");
	frame.setAttribute("alt", "");
	frame.setAttribute("id", "frame");
	slideshow.appendChild(frame);
	var preview = document.createElement("img");
	preview.setAttribute("src", "../../image/20190724/slideshow.jpg");
...
function preparPlaceholder() {
	...
	placeholder.setAttribute("src", "../../image/20190724/photo1.jpg");
	placeholder.setAttribute("alt", "bts's image galler");
...
/*通过label聚焦表单，因为个别浏览器不支持，为此添加该函数*/
...
function displayAjaxLoading(element) {
	...
	content.setAttribute("src", "../../image/20190724/ajax-loader.gif");
